...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  function initBannerSlider() {
    ...
    var slider = document.querySelector(".home4-banner-slider:not([data-igm-react-banner])");
  ...
  function initMissionVisionSlider() {
    ...
    var slider = document.querySelector(".mission-vision-slider:not([data-igm-react-mission-vision])");
    if (!slider) return true;
    if (slider.swiper) return true;
