...
ALTER TABLE "page_heroes" ADD COLUMN IF NOT EXISTS "strategy_cta_hero_image_id" integer;
...
DO $$ BEGIN ALTER TABLE "page_heroes" ADD CONSTRAINT "page_heroes_strategy_cta_hero_image_id_media_id_fk" FOREIGN KEY ("strategy_cta_hero_image_id") REFERENCES "media"("id") ON DELETE SET NULL; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
CREATE INDEX IF NOT EXISTS "page_heroes_strategy_cta_hero_image_idx" ON "page_heroes" ("strategy_cta_hero_image_id");
